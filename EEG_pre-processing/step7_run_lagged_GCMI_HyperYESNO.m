...
%
% 'NumSurrogates'
%   Requested maximum number of unique paired-trial derangement surrogates.
%   The actual number is reduced automatically when the number of possible
%   unique derangements is smaller than the requested value.
%   Default: 499
%
% 'RandomSeed'
...
%       'NumSurrogates', 0);
%
% Run one dyad and one situation with up to 499 unique surrogates:
%
%   [summaryTable, trialCountTable] = ...
%       step7_run_lagged_GCMI_HyperYESNO( ...
%       'E:\EEG_data_HyperYESNO', ...
...
for iDyad = 1:numel(dyads)
    ...
    for iSituation = 1:numel(situations)
        ...
        try
            ...
            if options.Verbose
                fprintf('Requested surrogates: %d; generated unique surrogates: %d\n', ...
            ...
            hyperyesno.requestedNumSurrogates = ...
                results.numberOfSurrogatesRequested;
            hyperyesno.actualNumSurrogates = ...
                results.numberOfSurrogatesGenerated;
            hyperyesno.maximumUniqueDerangements = ...
                results.maximumUniqueDerangements;
            hyperyesno.maximumUniqueDerangementsKnown = ...
                results.maximumUniqueDerangementsKnown;
            hyperyesno.maximumUniqueDerangementsDisplay = ...
                char(results.maximumUniqueDerangementsDisplay);
            hyperyesno.allUniqueDerangementsUsed = ...
                results.allUniqueDerangementsUsed;
            hyperyesno.surrogateGenerationMode = ...
                char(results.surrogateGenerationMode);
            hyperyesno.duplicateSurrogatePermutationsPrevented = true;
            ...
            record.ActualNumSurrogates = ...
                results.numberOfSurrogatesGenerated;

            record.MaximumUniqueDerangements = ...
                results.maximumUniqueDerangements;

            record.MaximumUniqueDerangementsKnown = ...
                results.maximumUniqueDerangementsKnown;

            record.MaximumUniqueDerangementsDisplay = ...
                string(results.maximumUniqueDerangementsDisplay);
            ...
            record.DuplicateSurrogatePermutationsPrevented = ...
                results.duplicateSurrogatePermutationsPrevented;

            record.SurrogateGenerationAttempts = ...
...
trialCountTable = summaryTable(:, { ...
    ...
    'ActualLagSamples', ...
    'ActualLagsMs', ...
    'RequestedNumSurrogates', ...
    'ActualNumSurrogates', ...
    'NumSurrogates', ...
    'MaximumUniqueDerangements', ...
    'MaximumUniqueDerangementsKnown', ...
    'MaximumUniqueDerangementsDisplay', ...
    'AllUniqueDerangementsUsed', ...
    'SurrogateGenerationMode', ...
    'DuplicateSurrogatePermutationsPrevented', ...
    'OutputFile', ...
    'Status', ...
    'ElapsedMinutes', ...
    'Notes'});
...
record = struct( ...
    ...
    'ActualLagSamples', "", ...
    'ActualLagsMs', "", ...
    'RequestedNumSurrogates', NaN, ...
    'ActualNumSurrogates', NaN, ...
    'NumSurrogates', NaN, ...
    'MaximumUniqueDerangements', NaN, ...
    'MaximumUniqueDerangementsKnown', false, ...
    'MaximumUniqueDerangementsDisplay', "", ...
    'AllUniqueDerangementsUsed', false, ...
    'SurrogateGenerationMode', "", ...
    'DuplicateSurrogatePermutationsPrevented', false, ...
    'SurrogateGenerationAttempts', NaN, ...
