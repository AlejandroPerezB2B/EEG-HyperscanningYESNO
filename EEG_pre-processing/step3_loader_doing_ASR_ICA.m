...
%
% 6. Run extended Infomax ICA with explicit PCA rank reduction.
%
% 7. Configure the standard MNI boundary-element model in DIPFIT and fit one
%    equivalent current dipole to every independent component.
%
...
%% Run extended Infomax ICA with explicit PCA rank control
...
%% Configure and run DIPFIT

numberOfComponents = size(EEG.icaweights, 1);

% The participant channel locations were assigned from an EEGLAB standard
% montage in Step 1. DIPFIT's standardBEM option selects the standard MNI
% boundary-element head model and its associated template resources.
