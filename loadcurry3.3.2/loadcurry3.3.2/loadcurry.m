...
%
%   If there is an error with this code, please email pontifex@msu.edu with the issue (and an example file that has the issue) and I'll see what I can do.
    ...
    if nargin < 1 % No file was identified in the call
        ...
        if ~strcmpi(r.Archive, 'Current')
            ...
            if (boolfiles == 1)
                ...
                % trigindx = find(strcmpi({EEG.chanlocs.labels},'Trigger')); commented by alej 2025-09-23
